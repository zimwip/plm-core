...
/**
 * Builds the full action + algorithm + permission snapshot for a service.
...
public class ActionConfigSnapshotService {

    private final DSLContext dsl;
    private final ServiceClient serviceClient;

    public record ActionConfigSnapshot(
        List<ActionConfig> actions,
        List<AlgorithmConfig> algorithms,
        List<PermissionConfig> permissions
    ) {}

    public ActionConfigSnapshot buildSnapshot(String serviceCode) {
        return new ActionConfigSnapshot(
