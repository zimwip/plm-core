 ...
 *
 * Implementations are Spring beans — any service can register its own scope
 * without import coupling.
 */
public interface ActionScope {

    /** Unique scope code matching action.scope column (e.g. "NODE", "TX", "GLOBAL"). */
    String code();
    ...
    /**
     * Builds an {@link ActionContext} from raw path IDs.
     *
     * @param actionId   the action.id being executed
