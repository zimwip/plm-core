 ...
 * </ol>
 *
 * <p>No longer writes to DB — admin tables are managed by psm-admin.
 */
@Slf4j
@Component
...
public class AlgorithmStartupValidator {
    ...
    /**
     * Step 1: Discover @AlgorithmType annotations on interfaces and validate they exist in ConfigCache.
     */
        ...
        for (Object bean : appCtx.getBeansWithAnnotation(AlgorithmBean.class).values()) {
            ...
            for (Class<?> iface : getAllInterfaces(clazz)) {
                ...
                for (AlgorithmType at : types) {
                    ...
                    // Validate type exists in ConfigCache via algorithms that reference it
    ...
    /**
     * Step 2: Discover @AlgorithmBean annotations and validate matching algorithm exists in ConfigCache.
     */
    ...
    /**
     * Step 3: Validate @AlgorithmParam annotations match parameters in ConfigCache.
     */
    private void syncParameters(Class<?> clazz, AlgorithmConfig alg, String algoCode) {
        ...
        // Warn about ConfigCache params not declared in annotation
    ...
    /**
     * Step 4: Reverse check — ConfigCache algorithms without matching beans.
     */
