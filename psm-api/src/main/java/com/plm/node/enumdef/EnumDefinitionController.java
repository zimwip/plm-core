package com.plm.node.enumdef;

import com.plm.node.enumdef.internal.EnumDefinitionService;
...
public class EnumDefinitionController {
    ...
    public ResponseEntity<Void> updateValue(
        ...
        enumService.updateValue(valueId,
            (String) body.get("value"),
            (String) body.get("label"),
    ...
    public ResponseEntity<Void> reorderValues(
            @PathVariable String enumId, @RequestBody List<String> valueIds) {
