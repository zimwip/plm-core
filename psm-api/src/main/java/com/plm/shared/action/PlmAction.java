 ...
 * The aspect checks {@code authorization_policy} using the target node type and
...
public @interface PlmAction {
     ...
     * {@code authorization_policy}. Leave empty for global, nodeType, or link variants.
     ...
     * {@link PolicyService#assertCanExecuteByCode}.
