...
public final class Enums {
    ...
    /**
     * Version policy on a NodeType — controls how the business version number
     * (revision.iteration) advances when a content checkout is performed.
     *
     *   NONE    → same revision.iteration (traceability only, no visible increment)
     *   ITERATE → iteration + 1  (A.1 → A.2)  — default
