 ...
 *
 * Responsibilities:
 *  1. Resolve the node_type_action and node_action rows.
...
public class ActionDispatcher {
    ...
    public ActionResult dispatch(
        ...
        // Load node_type_action + node_action
        ...
        // 1. Permission check
        permissionService.assertCanExecute(nodeTypeActionId, currentStateId);
