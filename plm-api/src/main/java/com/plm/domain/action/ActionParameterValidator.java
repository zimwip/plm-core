 ...
 * node_action_parameter, applying node_action_param_override when a
...
public class ActionParameterValidator {
     ...
     *
     * @param actionId         the node_action.id
    ...
    public Map<String, String> validate(String actionId, String nodeTypeActionId,
        ...
        List<Record> schema = dsl.select().from("node_action_parameter")
    ...
    public static class ValidationException extends com.plm.domain.exception.PlmFunctionalException {
